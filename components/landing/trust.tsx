...
export function Trust() {
  return (
    <section className="px-5 bg-gradient-color py-16 md:px-8 lg:px-0 lg:py-[100px]">
      ...
      <div className="mx-auto mb-10 grid max-w-[1277px] grid-cols-2 gap-4 lg:mb-16 lg:grid-cols-4 lg:gap-6">
        {stats.map((s) => (
          ...
          >
            <p className="text-[28px] font-bold tracking-[-1.02px] lg:text-[34px]">
              {s.value}
            </p>
          ...
          >
            ...
            <div className="flex flex-col justify-center gap-6 p-6 lg:p-10">
              ...
              <div className="flex flex-col gap-1.5">
                <p className="text-lg font-bold tracking-[0.54px] text-black">
                  {t.name}
                </p>
                <Image
                  src="/images/icon-5star.svg"
                  alt="5 stars"
                  width={80}
                  height={16}
                />
