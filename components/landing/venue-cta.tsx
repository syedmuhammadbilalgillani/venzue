...
export function VenueCta() {
  return (
    <section className="px-5 pb-10 md:px-8 lg:px-20">
      <div className="mx-auto flex max-w-7xl lg:flex-nowrap flex-wrap  justify-center lg:gap-6 gap-10 rounded-[20px] bg-linear-to-r from-gradient-from via-primary to-gradient-to p-8 ">
